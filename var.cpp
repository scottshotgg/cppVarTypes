    ...
    class var {
        ...
        public:
            void deallocate() {
                switch(type) {
                    case intType: {
                        cout << "int decons; Type: " << type << " Value: " << *(int*)data << " Pointer: " << data << endl;
                        delete (int*)data;
                        break;
                    }
                        
                    case stringType: {
                        cout << "string decons; Type: " << type << " Value: " << *(string*)data << " Pointer: " << data << endl;
                        delete (string*)data;
                        break;
                    }

                    case boolType: {
                        cout << "bool decons; Type: " << type << " Value: " << *(bool*)data << " Pointer: " << data << endl;
                        delete (bool*)data;
                        break;
                    }

                    case charType: {
                        cout << "char decons; Type: " << type << " Value: " << *(char*)data << " Pointer: " << data << endl;
                        delete (char*)data;
                        break;
                    }
                    
                    case floatType: {
                        cout << "float decons; Type: " << type << " Value: " << *(float*)data << " Pointer: " << data << endl;
                        delete (float*)data;
                        break;
                    }

                    case objectType: {
                        cout << "object decons; Type: " << type << " Value: " << *this << " Pointer: " << data << endl;
            ...
            var(int value) : type(intType), data(new int(value)) {
                cout << "int cons; Type: " << type << " Value: " << value << " Pointer: " << data << endl;
            }

            var(bool value) : type(boolType), data(new bool(value)) {
                cout << "bool cons; Type: " << type << " Value: " << value << " Pointer: " << data << endl;
            }
            
            var(char value) : type(charType), data(new char(value)) {}

            var(float value) : type(floatType), data(new float(value)) {
                cout << "float cons; Type: " << type << " Value: " << value << " Pointer: " << data << endl;
            }
            ...
            var(const char* value) : type(stringType), data(new string(value)) {
                cout << "string cons; Type: " << type << " Value: \"" << value << "\" Pointer: " << data << endl;
            }
            ...
            void operator=(const char* right) {
                if (type == stringType) {
                    *(string*)data = right;
                    ...
                    // var::~var();
                    deallocate();
                    cout << "string cons; Type: " << type << " Value: \"" << right << "\" Pointer: " << data << endl;
                    type = stringType;
            ...
            void operator=(initializer_list<var> propList) {
                deallocate();
                // cout << "object cons; Type: " << type << " Value: " << propList << " Pointer: " << data << endl;
